...
class Agentes {
  ...
  Agentes({this.id, this.clave, this.nombre});
  ...
  factory Agentes.fromMap(Map<String, dynamic> map) {
    return Agentes(id: map['id'], clave: map['clave'], nombre: map['nombre']);
  }
...
class Calles {
  ...
  Calles({this.id, this.clave, this.nombre});
  ...
  factory Calles.fromMap(Map<String, dynamic> map) {
    return Calles(id: map['id'], clave: map['clave'], nombre: map['nombre']);
  }

  @override
  String toString() {
    return 'Calles{id: $id, clave: $clave, nombre: $nombre}';
  }
}
...
class Colonias {
  ...
  Colonias({this.id, this.clave, this.nombre});
  ...
  factory Colonias.fromMap(Map<String, dynamic> map) {
    return Colonias(id: map['id'], clave: map['clave'], nombre: map['nombre']);
  }
...
class Departamentos {
  ...
  Departamentos({this.id, this.clave, this.nombre});
  ...
  @override
  String toString() {
    return 'Departamentos{id: $id, clave: $clave, nombre: $nombre}';
  }
}
...
class Estados {
  ...
  Estados({this.id, this.clave, this.nombre});
  ...
  @override
  String toString() {
    return 'Estados{id: $id, clave: $clave, nombre: $nombre}';
  }
}
