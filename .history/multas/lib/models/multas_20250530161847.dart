...
class Lote {
  ...
  Lote({this.id, this.clave, this.nombre});
  ...
  @override
  String toString() {
    return 'Lote{id: $id, clave: $clave, nombre: $nombre}';
  }
}
...
class Marca {
  ...
  Marca({this.id, this.clave, this.nombre});
  ...
  @override
  String toString() {
    return 'Marca{id: $id, clave: $clave, nombre: $nombre}';
  }
}
...
class Motivo {
  ...
  factory Motivo.fromMap(Map<String, dynamic> map) {
    return Motivo(
      id: map['id'],
      clave: map['clave']?.toString(),
      nombre: map['nombre']?.toString(),
  ...
  @override
  String toString() {
    return 'Motivo{id: $id, clave: $clave, nombre: $nombre, uma: $uma, descuento: $descuento, periodoDescuento: $periodoDescuento, peritos: $peritos, articulo: $articulo, fraccion: $fraccion, sancion: $sancion}';
  }
}
