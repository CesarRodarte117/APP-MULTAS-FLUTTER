...
class _InfraccionState extends State<Infraccion> {
  ...
  Widget _buildInfractorForm() {
    return Column(
      children: [
        // Número de licencia (teclado numérico)
        TextFormField(
          decoration: const InputDecoration(labelText: "Número de licencia"),
          keyboardType: TextInputType.number,
        ),

        // Estado de origen (licencia) - Texto normal
        TextFormField(
          decoration: const InputDecoration(
            labelText: "Estado de origen (licencia)",
          ),
        ),
        ...
        // Apellido paterno - Texto normal
        TextFormField(
          decoration: const InputDecoration(labelText: "Apellido paterno"),
        ),

        // Apellido materno - Texto normal
        TextFormField(
          decoration: const InputDecoration(labelText: "Apellido materno"),
        ),

        // Género - Texto normal (podrías usar un DropdownButton aquí)
        TextFormField(decoration: const InputDecoration(labelText: "Género")),
        ...
        // N° Exterior - Teclado numérico
        TextFormField(
          decoration: const InputDecoration(labelText: "N° Exterior"),
          keyboardType: TextInputType.number,
        ),

        // N° Interior - Teclado numérico
        TextFormField(
          decoration: const InputDecoration(labelText: "N° Interior"),
          keyboardType: TextInputType.number,
        ),

        // Colonia - Texto normal
        TextFormField(decoration: const InputDecoration(labelText: "Colonia")),

        // Código Postal - Teclado numérico
        TextFormField(
          decoration: const InputDecoration(labelText: "Código Postal"),
          keyboardType: TextInputType.number,
        ),

        // Teléfono - Teclado numérico (puedes usar phone para mejor soporte)
        TextFormField(
