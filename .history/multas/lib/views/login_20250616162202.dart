...
class _loginPageState extends State<LoginPage> {
  ...
  void _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (matricula == '666' && password == '666') {
        ...
        List<Calles> calles = await _cargarCallesDBExterna();
  ...
  // Ejecutar consulta
  final results = await connection.query('SELECT id, clave, nombre FROM calles');

  // Cerrar conexión
  await connection.close();

  // Mapear resultados a objetos Calles
