...
class _InfraccionState extends State<Infraccion> {
  ...
  Estado? _estadoSeleccionado; // Variable para almacenar el estado seleccionado
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(width: 10),
            GenericAutocomplete<Calle>(
              fetchItems: (query) => dbHelper.buscarCalles(query),
              onItemSelected: (calle) {
                setState(() {
                  _calleSeleccionada = calle;
                });
              },
              itemDisplayName: (calle) => calle.nombre,
              labelText: "Calle",
